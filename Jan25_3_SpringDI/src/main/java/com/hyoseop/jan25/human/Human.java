package com.hyoseop.jan25.human;
...
import com.hyoseop.jan25.bird.Bird;
import com.hyoseop.jan25.dog.Dog;
...
public class Human {
	...
	//.xml에 등록된 Bird 객체 자동으로 연결 (생성자, setter 필요없음)
